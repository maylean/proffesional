...
if (!empty($_POST)) {
   ...
   $query        = " SELECT 1 FROM getjob WHERE email = :email";
   ...
   if ($row) {
    ...
    $query = "INSERT INTO getjob ( firstname, lastname,email,phone,password ) VALUES ( :firstname, :lastname,:email,:phonenumber,:password ) ";
...
?>
	...
	<h1>Register</h1> 
	<form action="registerfreelancer.php" method="post"> 
	    Firsr name:<br /> 
